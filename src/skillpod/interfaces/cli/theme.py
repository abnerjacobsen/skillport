...
def is_interactive() -> bool:
    ...
    if os.environ.get("SKILLPOD_NO_INTERACTIVE"):
        return False
...
def empty_skills_panel() -> Panel:
    ...
    return Panel(
        ...
        "Get started:\n"
        "  [info]skillpod add hello-world[/info]  Add sample skill\n"
        "  [info]skillpod add template[/info]     Create your own skill\n\n"
        "[dim]Learn more: skillpod --help[/dim]",
        title="Skills (0)",
        border_style="dim",
    )
...
def no_results_panel(query: str) -> Panel:
    ...
    return Panel(
        ...
        "  [dim]-[/dim] Run [info]skillpod list[/info] to see all skills",
